defmodule FarmcontrolWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FarmcontrolWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FarmcontrolWeb.Gettext, "errors", msg, opts)
    end
  end
