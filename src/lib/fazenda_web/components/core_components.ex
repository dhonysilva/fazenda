defmodule FazendaWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FazendaWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FazendaWeb.Gettext, "errors", msg, opts)
    end
  end
